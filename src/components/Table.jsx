...
const TableFilters=()=>
{
    return (
        <section className='flex justify-between'>
            <aside className="flex w-fit space-x-2 py-2.5 px-4 items-center border border-border rounded">
    ...
    return (
        <tr >
            <td className='text-[#146EB4] px-0 text-sm leading-5 font-medium '>
              <p className={`${tableData.length===(index + 1)?"":"border-b"} border-background-light py-3.5 ml-3`}>#{orderId}</p>
            </td>
            <td className=' p-0 text-sm leading-5 '>
              <section className={`${tableData.length===(index + 1)?"":"border-b"}  px-3 py-3.5  border-background-light flex items-center space-x-1.5`}>
            ...
            <td className='text-text p-0  text-sm leading-5'>
              <p className={`${tableData.length===(index + 1)?"":"border-b"} border-background-light py-3.5 px-3`}>{transactionID}</p>
              </td>
            <td className='text-text  p-0 text-sm leading-5'>
              <p className={`${tableData.length===(index + 1)?"":"border-b"} border-background-light py-3.5 px-3`}>{refundDate}</p>
              </td>
    ...
    <div className="bg-white border border-white  rounded-lg p-3 space-y-3" style={{boxShadow: "0px 2px 6px 0px rgba(26, 24, 30, 0.04)"}}>
        ...
        <table className=' w-full text-left border-collapse '>
            <tr className="bg-[#F2F2F2]">
                <th className='text-text py-2.5 px-3 font-medium bg-[#F2F2F2] rounded-l text-sm'>Order ID</th>
                <th className='text-text py-2.5 px-3 font-medium bg-[#F2F2F2] text-sm'>Status</th>
                <th className='text-text py-2.5 px-3 font-medium bg-[#F2F2F2] text-sm'>Transaction ID</th>
                <th className='text-text py-2.5 px-3 font-medium bg-[#F2F2F2] text-sm'>Refund date</th>
                <th className="text-text py-2.5 px-3 font-medium bg-[#F2F2F2] rounded-r text-sm text-right">Order amount</th>
            </tr>
